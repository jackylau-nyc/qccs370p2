...
class AdminLink extends BaseLink {
    ...
    function getAllReservations($companyName){
        $sql = "SELECT rc_junc.customer_username, hotel.x_cord, hotel.y_cord, rc_junc.reservation_id, hotel.company, res.res_start, res.res_end, rm.room_num, rm.class, rm.price, hotel.location
                FROM hotel
